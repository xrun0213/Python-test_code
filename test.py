...
class Example(tk.Frame):
    def __init__(self, root):
        ...
        self.canvas.bind("<MouseWheel>", self.show)
        self.canvas.bind("<Button-1>", self.show)
        self.canvas.bind("<Enter>", self.show)
        self.canvas.bind("<Motion>", self.show)
        self.canvas.bind("<Button-4>", self.show)
        self.canvas.bind("<Button-5>", self.show)
